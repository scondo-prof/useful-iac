...
output "ecr_repository_url" {
  ...
  value       = aws_ecr_repository.lambda_ecr_repository.repository_url
}

output "ecr_repository_arn" {
  description = "The ARN of the ECR repository"
  value       = aws_ecr_repository.lambda_ecr_repository.arn
}

output "ecr_repository_name" {
  description = "The name of the ECR repository"
  value       = aws_ecr_repository.lambda_ecr_repository.name
}
